...
type ClassScheduleForUpdate struct {
...
func GetClassScheduleByID(c *gin.Context) {
	...
	if tx := entity.DB().Where("class_schedule_id", class_schedule_id).First(&class_schedules); tx.RowsAffected == 0 {
